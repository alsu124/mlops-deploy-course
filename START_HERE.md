...
### Шаг 5: Сдай работу (создай Pull Request)
- Создай свой GitHub репо
- Пушь туда свои изменения
- Создай PR на проверку
...
**Нужен ли мне бот?**
→ НЕТ! Ты работаешь самостоятельно. Бот только для преподавателя.

**Как я буду сдавать?**
→ GitHub репо + Pull Request (смотри HOW_TO_SUBMIT_LABS.md)
